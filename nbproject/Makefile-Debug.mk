...
${OBJECTDIR}/RuntimeError.o: RuntimeError.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/usr/include -I/usr/include/c++/4.8.2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RuntimeError.o RuntimeError.cpp
...
${OBJECTDIR}/parser.o: parser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/usr/include -I/usr/include/c++/4.8.2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parser.o parser.cpp

${OBJECTDIR}/scanner.o: scanner.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/usr/include -I/usr/include/c++/4.8.2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scanner.o scanner.cpp

${OBJECTDIR}/usage/CustomOptionDescription.o: usage/CustomOptionDescription.cpp 
	${MKDIR} -p ${OBJECTDIR}/usage
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/usr/include -I/usr/include/c++/4.8.2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/usage/CustomOptionDescription.o usage/CustomOptionDescription.cpp

${OBJECTDIR}/usage/OptionPrinter.o: usage/OptionPrinter.cpp 
	${MKDIR} -p ${OBJECTDIR}/usage
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/usr/include -I/usr/include/c++/4.8.2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/usage/OptionPrinter.o usage/OptionPrinter.cpp
